# Reflective Agent Architecture: Structural Analysis (2025-12-10)

This document provides a comprehensive structural map of the `reflective-agent-architecture` codebase as of December 10, 2025. It breaks down components, dependencies, and data flow, organized alphabetically by directory for easier navigation.
...
- [`cognitive_diagnostics.py`](src/cognition/cognitive_diagnostics.py): **Diagnostics** - Analysis of cognitive state (Semantic Looping, Fixation).
...
Putnamian Evolution Framework components.

- [`stress_sensor.py`](src/evolution/stress_sensor.py): **Desire Lines** - Detects high-stress, high-frequency patterns for crystallization.
...
- [`operation_categories.py`](src/substrate/operation_categories.py): **Taxonomy** - Classifies operations for diagnostics.
