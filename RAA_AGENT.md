...
- **CRITICAL**: Do not interpret "sleep" as a command for _you_ (the LLM) to stop generating or roleplay sleeping. It is a command to trigger the **System 2 Sleep Cycle**. Always use the tool.
