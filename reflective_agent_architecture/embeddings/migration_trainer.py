...
from reflective_agent_architecture.vectordb_migrate.migration import EmbeddingMigration
...
def train_projection(
    ...
    # Train
    from reflective_agent_architecture.vectordb_migrate.loss_functions import HybridLoss
