...
from reflective_agent_architecture.cognition.generative_function import GenerativeFunction

if TYPE_CHECKING:
    from reflective_agent_architecture.cognition.stereoscopic_engine import StereoscopicEngine
