...
class EnergyToken:
    ...
    def __sub__(self, other: "EnergyToken") -> "EnergyToken":
        ...
        if self.unit != other.unit:
            raise ValueError(f"Cannot subtract tokens with different units: {self.unit} vs {other.unit}")
    ...
    def __lt__(self, other: "EnergyToken") -> bool:
        ...
        if self.unit != other.unit:
            raise ValueError(f"Cannot compare tokens with different units: {self.unit} vs {other.unit}")
