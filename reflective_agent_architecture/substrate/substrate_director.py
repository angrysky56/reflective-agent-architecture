...
class SubstrateAwareDirector:
    ...
    def record_operation(
        ...
        cost = MeasurementCost(energy=scaled_cost, operation_name=f"raa_{operation_type}")
    ...
    def _scale_cost(
        self, base: EnergyToken, entropy: Optional[float], manifold_energy: Optional[float]
    ) -> EnergyToken:
    ...
    def _auto_recharge(self) -> None:
        ...
        self._operation_counts["recharge"] = self._operation_counts.get("recharge", 0) + 1
